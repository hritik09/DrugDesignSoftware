...
public class App extends JFrame 
{
   ...
   try{
	...
	public void initComponents() 
	{
		...
		relationaldisplay.setToolTipText("Drugs targeting this protein");
					...
					Desktop desktop = Desktop.getDesktop();
	 				try
	 				{
	 					...
	 					if (osName.toLowerCase().contains("mac")) {
			                ...
			                path = path.concat("Help\\User Manual.pdf");
						...
						public void actionPerformed(ActionEvent ex)
						{
							if( !PDBid.matches("") && string.matches(".pdb"))
							  { 
								...
								String path = "/Hisory/"+ PDBid + string;
								
								ForceFieldCalculator ffc = new ForceFieldCalculator();
								double value = ffc.energybtwnBondedAtom(path, ka, kb);
								
								String s = "Potential Energy between Bonded Atom is " + value +" Kcal/mol/armstrong^2";
